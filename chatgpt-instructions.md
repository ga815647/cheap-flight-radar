...
1. Repo is `ga815647/cheap-flight-radar` (github.com, branch `main` is source of truth). Read `AGENTS.md`, `PRODUCT_INTENT.md`, full `flight-radar.yaml` (SSOT wins), then `docs/daily-flight-radar-automation-prompt.md`. Resolve today (Asia/Taipei).
