...
3. Submission is not completion. Wait for the triggered workflow's terminal state, then read back final evidence from `history/price-observations` (claim, snapshot, `run-result.json`, `publication-manifest.json`, Pages dispatch).
