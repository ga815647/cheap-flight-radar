...
def validate_absolute_low_policy(policy: Mapping[str, Any]) -> Mapping[str, Any]:
    ...
    if str(producer.get("canonical_ftr_activation") or "") != "retired_downstream_feed_removed":
        raise FTRAbsoluteLowPolicyError("downstream feed retirement boundary drifted")
    return producer
